...
DEVOPS="https://keva.visualstudio.com/Verkkopalvelut%20-%20OET%202.0/_sprints/backlog/Verkkopalvelut%20-%20OET%202.0%20Team/Verkkopalvelut%20-%20OET%202.0/Sprint%218"
...
if [[ "$TMUX_SESSIONS" == "0" ]]; then
	...
	tmux new-session -s $SESSION_NAME -n $WINDOW1_NAME -c "$PROJECT_DIR" \; \
		...
		send-keys 'pgrep dotnet 1>/dev/null 2>&1 || dotnet watch --project src/Skylla.BE.API run' C-m \; \
