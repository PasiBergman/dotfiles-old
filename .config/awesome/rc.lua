...
beautiful.hotkeys_fg = "#fafafa"
beautiful.hotkeys_modifiers_fg = "#9999ff"
beautiful.hotkeys_font = "FiraCode Nerd Font 9"
beautiful.hotkeys_description_font = "FiraCode Nerd Font 9"
...
--
-- Startup programs in the background
--
-- Add gaps
beautiful.useless_gap = 6
-- Set keyboard layout to Mac Finnish layout
awful.spawn.with_shell("setxkbmap -model macbook78 -layout fi")
-- Parallels Toolls: adapt to resolution changes
awful.spawn.with_shell("prlcc")
-- Enable transparency
awful.spawn.with_shell(
    "picom -f --config $HOME/.config/picom/picom.conf 2>$HOME/.config/picom/picom.log")
-- Set wallpaper
awful.spawn.with_shell(
    "feh --randomize --bg-fill $HOME/Pictures/Wallpapers/nature-wallpapers/*")
-- Start polybar
awful.spawn.with_shell("$HOME/.config/polybar/launch.sh")
-- Bind feh refresh to screen resolution change
awful.spawn.with_shell(
    "/usr/bin/xeventbind resolution $HOME/.config/awesome/scripts/resolution-change.sh")
